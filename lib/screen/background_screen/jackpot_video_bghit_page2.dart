...
class JackpotHitShowScreenV2 extends StatefulWidget {
  final String number;
  final String value;
  final String id;

  const JackpotHitShowScreenV2({
    super.key,
  ...
  @override
  _JackpotHitShowScreenV2State createState() => _JackpotHitShowScreenV2State();
}

class _JackpotHitShowScreenV2State extends State<JackpotHitShowScreenV2>
  ...
  @override
  void didUpdateWidget(JackpotHitShowScreenV2 oldWidget) {
